...
class DocumentPaymentService
{
    ...
    public static function requestRules(): array
    {
        ...
        return array_merge([
            ...
            'payments.*.cheque.cheque_number' => 'required_with:payments.*.cheque|string|max:64',
            'payments.*.cheque.bank_name' => 'nullable|string|max:255',
            'payments.*.cheque.payee' => 'nullable|string|max:255',
            'payments.*.cheque.title' => 'nullable|string|max:255',
            'payments.*.cheque.note' => 'nullable|string',
            'payments.*.cheque.due_date' => 'required_with:payments.*.cheque|array',
            'payments.*.cheque.due_date.year' => 'required_with:payments.*.cheque.due_date|integer',
            'payments.*.cheque.due_date.month' => 'required_with:payments.*.cheque.due_date|integer|min:1|max:12',
            'payments.*.cheque.due_date.day' => 'required_with:payments.*.cheque.due_date|integer|min:1|max:31',
            'payments.*.cheque.issue_date' => 'nullable|array',
            'payments.*.cheque.type' => 'nullable|string|max:32',
