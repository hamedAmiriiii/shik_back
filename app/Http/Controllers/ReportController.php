...
class ReportController extends Controller
{
    ...
    private function formatPeriodReport(array $data): array
    {
        return [
            ...
            'debts_collected' => $data['debts_collected'] ?? 0,
            'cheques_collected' => $data['cheques_collected'] ?? 0,
            'cheque_payments' => $data['cheque_payments'] ?? 0,
            'total_collected' => $data['total_collected'],
            'uncollected_installments' => $data['uncollected_installments'],
            'uncollected_debts' => $data['uncollected_debts'] ?? 0,
            'uncollected_cheques' => $data['uncollected_cheques'] ?? 0,
            'open_cheques' => $data['open_cheques'] ?? 0,
